...
public class RenderBlocksInverted {
    ...
    public boolean renderStandardBlock(RenderBlocks renderer, Block par1Block, int par2, int par3, int par4) {
        ...
        if (Minecraft.isAmbientOcclusionEnabled()
            && par1Block.getLightValue(renderer.blockAccess, par2, par3, par4) == 0) {
            if (renderer.partialRenderBounds) {
                return this
                    .renderStandardBlockWithAmbientOcclusionPartial(renderer, par1Block, par2, par3, par4, f, f1, f2);
            } else {
                return this.renderStandardBlockWithAmbientOcclusion(renderer, par1Block, par2, par3, par4, f, f1, f2);
            }
        } else {
            return this.renderStandardBlockWithColorMultiplier(renderer, par1Block, par2, par3, par4, f, f1, f2);
        }
    }

    public boolean renderStandardBlockWithAmbientOcclusionPartial(RenderBlocks renderer, Block par1Block, int par2,
        int par3, int par4, float par5, float par6, float par7) {
        ...
        if (renderer.getBlockIcon(par1Block)
            .getIconName()
            .equals("grass_top")) {
            flag1 = false;
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 - 1, par4, 0)) {
            ...
            renderer.aoBrightnessXYNN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4);
            renderer.aoBrightnessYZNN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3, par4 - 1);
            renderer.aoBrightnessYZNP = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3, par4 + 1);
            renderer.aoBrightnessXYPN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4);
            renderer.aoLightValueScratchXYNN = renderer.blockAccess.getBlock(par2 - 1, par3, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNN = renderer.blockAccess.getBlock(par2, par3, par4 - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNP = renderer.blockAccess.getBlock(par2, par3, par4 + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPN = renderer.blockAccess.getBlock(par2 + 1, par3, par4)
                .getAmbientOcclusionLightValue();
            flag3 = renderer.blockAccess.getBlock(par2 + 1, par3 - 1, par4)
                .getCanBlockGrass();
            flag2 = renderer.blockAccess.getBlock(par2 - 1, par3 - 1, par4)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(par2, par3 - 1, par4 + 1)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(par2, par3 - 1, par4 - 1)
                .getCanBlockGrass();
            ...
            if (!flag4 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess.getBlock(par2 - 1, par3, par4 - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4 - 1);
            }
            ...
            if (!flag5 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZNNP = renderer.blockAccess.getBlock(par2 - 1, par3, par4 + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4 + 1);
            }
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZPNN = renderer.blockAccess.getBlock(par2 + 1, par3, par4 - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4 - 1);
            }
            ...
            if (!flag5 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZPNP = renderer.blockAccess.getBlock(par2 + 1, par3, par4 + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4 + 1);
            }
            ...
            if (renderer.renderMinY <= 0.0D
                || !par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 - 1, par4, 0)) {
                i1 = par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4);
            }

            f7 = renderer.blockAccess.getBlock(par2, par3 - 1, par4)
                .getAmbientOcclusionLightValue();
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 + 1, par4, 1)) {
            ...
            renderer.aoBrightnessXYNP = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4);
            renderer.aoBrightnessXYPP = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4);
            renderer.aoBrightnessYZPN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3, par4 - 1);
            renderer.aoBrightnessYZPP = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3, par4 + 1);
            renderer.aoLightValueScratchXYNP = renderer.blockAccess.getBlock(par2 - 1, par3, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPP = renderer.blockAccess.getBlock(par2 + 1, par3, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPN = renderer.blockAccess.getBlock(par2, par3, par4 - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPP = renderer.blockAccess.getBlock(par2, par3, par4 + 1)
                .getAmbientOcclusionLightValue();
            flag3 = renderer.blockAccess.getBlock(par2 + 1, par3 + 1, par4)
                .getCanBlockGrass();
            flag2 = renderer.blockAccess.getBlock(par2 - 1, par3 + 1, par4)
            ...
            if (!flag4 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZNPN = renderer.blockAccess.getBlock(par2 - 1, par3, par4 - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4 - 1);
            }
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZPPN = renderer.blockAccess.getBlock(par2 + 1, par3, par4 - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4 - 1);
            }
            ...
            if (!flag5 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZNPP = renderer.blockAccess.getBlock(par2 - 1, par3, par4 + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4 + 1);
            }
            ...
            if (!flag5 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZPPP = renderer.blockAccess.getBlock(par2 + 1, par3, par4 + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4 + 1);
            }
            ...
            if (renderer.renderMaxY >= 1.0D
                || !par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 + 1, par4, 1)) {
                i1 = par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 + 1, par4);
            }
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 - 1, 2)) {
            ...
            renderer.aoLightValueScratchXZNN = renderer.blockAccess.getBlock(par2 - 1, par3, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNN = renderer.blockAccess.getBlock(par2, par3 - 1, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPN = renderer.blockAccess.getBlock(par2, par3 + 1, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPN = renderer.blockAccess.getBlock(par2 + 1, par3, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXZNN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4);
            renderer.aoBrightnessYZNN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4);
            renderer.aoBrightnessYZPN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 + 1, par4);
            renderer.aoBrightnessXZPN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4);
            flag3 = renderer.blockAccess.getBlock(par2 + 1, par3, par4 - 1)
                .getCanBlockGrass();
            flag2 = renderer.blockAccess.getBlock(par2 - 1, par3, par4 - 1)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(par2, par3 + 1, par4 - 1)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(par2, par3 - 1, par4 - 1)
            ...
            if (!flag2 && !flag4) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess.getBlock(par2 - 1, par3 - 1, par4)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3 - 1, par4);
            }
            ...
            if (!flag2 && !flag5) {
                ...
                renderer.aoLightValueScratchXYZNPN = renderer.blockAccess.getBlock(par2 - 1, par3 + 1, par4)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3 + 1, par4);
            }
            ...
            if (!flag3 && !flag4) {
                ...
                renderer.aoLightValueScratchXYZPNN = renderer.blockAccess.getBlock(par2 + 1, par3 - 1, par4)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3 - 1, par4);
            }
            ...
            if (!flag3 && !flag5) {
                ...
                renderer.aoLightValueScratchXYZPPN = renderer.blockAccess.getBlock(par2 + 1, par3 + 1, par4)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3 + 1, par4);
            }
            ...
            if (renderer.renderMinZ <= 0.0D
                || !par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 - 1, 2)) {
                i1 = par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2, par3, par4 - 1);
            }

            f7 = renderer.blockAccess.getBlock(par2, par3, par4 - 1)
                .getAmbientOcclusionLightValue();
            f9 = (renderer.aoLightValueScratchXZNN + renderer.aoLightValueScratchXYZNPN
                + f7
                + renderer.aoLightValueScratchYZPN) / 4.0F;
            ...
            f10 = (renderer.aoLightValueScratchXYZNNN + renderer.aoLightValueScratchXZNN
                + renderer.aoLightValueScratchYZNN
                + f7) / 4.0F;
            f3 = (float) (f9 * renderer.renderMaxY * (1.0D - renderer.renderMinX)
                + f8 * renderer.renderMinY * renderer.renderMinX
                + f11 * (1.0D - renderer.renderMaxY) * renderer.renderMinX
                + f10 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMinX));
            f4 = (float) (f9 * renderer.renderMaxY * (1.0D - renderer.renderMaxX)
                + f8 * renderer.renderMaxY * renderer.renderMaxX
                + f11 * (1.0D - renderer.renderMaxY) * renderer.renderMaxX
                + f10 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMaxX));
            f5 = (float) (f9 * renderer.renderMinY * (1.0D - renderer.renderMaxX)
                + f8 * renderer.renderMinY * renderer.renderMaxX
                + f11 * (1.0D - renderer.renderMinY) * renderer.renderMaxX
                + f10 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMaxX));
            f6 = (float) (f9 * renderer.renderMinY * (1.0D - renderer.renderMinX)
                + f8 * renderer.renderMinY * renderer.renderMinX
                + f11 * (1.0D - renderer.renderMinY) * renderer.renderMinX
                + f10 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMinX));
            k1 = renderer
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 + 1, 3)) {
            ...
            renderer.aoLightValueScratchXZNP = renderer.blockAccess.getBlock(par2 - 1, par3, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPP = renderer.blockAccess.getBlock(par2 + 1, par3, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNP = renderer.blockAccess.getBlock(par2, par3 - 1, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPP = renderer.blockAccess.getBlock(par2, par3 + 1, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXZNP = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4);
            renderer.aoBrightnessXZPP = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4);
            renderer.aoBrightnessYZNP = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4);
            renderer.aoBrightnessYZPP = par1Block
            ...
            if (!flag2 && !flag4) {
                ...
                renderer.aoLightValueScratchXYZNNP = renderer.blockAccess.getBlock(par2 - 1, par3 - 1, par4)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3 - 1, par4);
            }
            ...
            if (!flag2 && !flag5) {
                ...
                renderer.aoLightValueScratchXYZNPP = renderer.blockAccess.getBlock(par2 - 1, par3 + 1, par4)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3 + 1, par4);
            }
            ...
            if (!flag3 && !flag4) {
                ...
                renderer.aoLightValueScratchXYZPNP = renderer.blockAccess.getBlock(par2 + 1, par3 - 1, par4)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3 - 1, par4);
            }
            ...
            if (!flag3 && !flag5) {
                ...
                renderer.aoLightValueScratchXYZPPP = renderer.blockAccess.getBlock(par2 + 1, par3 + 1, par4)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3 + 1, par4);
            }
            ...
            if (renderer.renderMaxZ >= 1.0D
                || !par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 + 1, 3)) {
                i1 = par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2, par3, par4 + 1);
            }

            f7 = renderer.blockAccess.getBlock(par2, par3, par4 + 1)
                .getAmbientOcclusionLightValue();
            f9 = (renderer.aoLightValueScratchXZNP + renderer.aoLightValueScratchXYZNPP
                + f7
            ...
            f10 = (renderer.aoLightValueScratchXYZNNP + renderer.aoLightValueScratchXZNP
                + renderer.aoLightValueScratchYZNP
                + f7) / 4.0F;
            f3 = (float) (f9 * renderer.renderMaxY * (1.0D - renderer.renderMinX)
                + f8 * renderer.renderMaxY * renderer.renderMinX
                + f11 * (1.0D - renderer.renderMaxY) * renderer.renderMinX
                + f10 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMinX));
            f4 = (float) (f9 * renderer.renderMinY * (1.0D - renderer.renderMinX)
                + f8 * renderer.renderMinY * renderer.renderMinX
                + f11 * (1.0D - renderer.renderMinY) * renderer.renderMinX
                + f10 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMinX));
            f5 = (float) (f9 * renderer.renderMinY * (1.0D - renderer.renderMaxX)
                ...
                + f11 * (1.0D - renderer.renderMinY) * renderer.renderMaxX
                + f10 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMaxX));
            f6 = (float) (f9 * renderer.renderMaxY * (1.0D - renderer.renderMaxX)
                + f8 * renderer.renderMaxY * renderer.renderMaxX
                + f11 * (1.0D - renderer.renderMaxY) * renderer.renderMaxX
                + f10 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMaxX));
            k1 = renderer
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 - 1, par3, par4, 4)) {
            ...
            renderer.aoLightValueScratchXYNN = renderer.blockAccess.getBlock(par2, par3 - 1, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZNN = renderer.blockAccess.getBlock(par2, par3, par4 - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZNP = renderer.blockAccess.getBlock(par2, par3, par4 + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYNP = renderer.blockAccess.getBlock(par2, par3 + 1, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXYNN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4);
            renderer.aoBrightnessXZNN = par1Block
            ...
            flag2 = renderer.blockAccess.getBlock(par2 - 1, par3 - 1, par4)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(par2 - 1, par3, par4 - 1)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(par2 - 1, par3, par4 + 1)
                .getCanBlockGrass();
            ...
            if (!flag5 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess.getBlock(par2, par3 - 1, par4 - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4 - 1);
            }
            ...
            if (!flag4 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZNNP = renderer.blockAccess.getBlock(par2, par3 - 1, par4 + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4 + 1);
            }
            ...
            if (!flag5 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNPN = renderer.blockAccess.getBlock(par2, par3 + 1, par4 - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 + 1, par4 - 1);
            }
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNPP = renderer.blockAccess.getBlock(par2, par3 + 1, par4 + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 + 1, par4 + 1);
            }
            ...
            if (renderer.renderMinX <= 0.0D
                || !par1Block.shouldSideBeRendered(renderer.blockAccess, par2 - 1, par3, par4, 4)) {
                i1 = par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4);
            }

            f7 = renderer.blockAccess.getBlock(par2 - 1, par3, par4)
                .getAmbientOcclusionLightValue();
            f9 = (renderer.aoLightValueScratchXYNN + renderer.aoLightValueScratchXYZNNP
                + f7
            ...
            f10 = (renderer.aoLightValueScratchXYZNNN + renderer.aoLightValueScratchXYNN
                + renderer.aoLightValueScratchXZNN
                + f7) / 4.0F;
            f3 = (float) (f8 * renderer.renderMaxY * renderer.renderMaxZ
                + f11 * renderer.renderMaxY * (1.0D - renderer.renderMaxZ)
                + f10 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMaxZ)
                + f9 * (1.0D - renderer.renderMaxY) * renderer.renderMaxZ);
            f4 = (float) (f8 * renderer.renderMaxY * renderer.renderMinZ
                + f11 * renderer.renderMaxY * (1.0D - renderer.renderMinZ)
                + f10 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMinZ)
                + f9 * (1.0D - renderer.renderMaxY) * renderer.renderMinZ);
            f5 = (float) (f8 * renderer.renderMinY * renderer.renderMinZ
                + f11 * renderer.renderMinY * (1.0D - renderer.renderMinZ)
                + f10 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMinZ)
                + f9 * (1.0D - renderer.renderMinY) * renderer.renderMinZ);
            f6 = (float) (f8 * renderer.renderMinY * renderer.renderMaxZ
                + f11 * renderer.renderMinY * (1.0D - renderer.renderMaxZ)
                + f10 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMaxZ)
                + f9 * (1.0D - renderer.renderMinY) * renderer.renderMaxZ);
            k1 = renderer
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 + 1, par3, par4, 5)) {
            ...
            renderer.aoLightValueScratchXYPN = renderer.blockAccess.getBlock(par2, par3 - 1, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPN = renderer.blockAccess.getBlock(par2, par3, par4 - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPP = renderer.blockAccess.getBlock(par2, par3, par4 + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPP = renderer.blockAccess.getBlock(par2, par3 + 1, par4)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXYPN = par1Block
                .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4);
            renderer.aoBrightnessXZPN = par1Block
            ...
            if (!flag2 && !flag4) {
                ...
                renderer.aoLightValueScratchXYZPNN = renderer.blockAccess.getBlock(par2, par3 - 1, par4 - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4 - 1);
            }
            ...
            if (!flag2 && !flag5) {
                ...
                renderer.aoLightValueScratchXYZPNP = renderer.blockAccess.getBlock(par2, par3 - 1, par4 + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4 + 1);
            }
            ...
            if (!flag3 && !flag4) {
                ...
                renderer.aoLightValueScratchXYZPPN = renderer.blockAccess.getBlock(par2, par3 + 1, par4 - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPN = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 + 1, par4 - 1);
            }
            ...
            if (!flag3 && !flag5) {
                ...
                renderer.aoLightValueScratchXYZPPP = renderer.blockAccess.getBlock(par2, par3 + 1, par4 + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPP = par1Block
                    .getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 + 1, par4 + 1);
            }
            ...
            if (renderer.renderMaxX >= 1.0D
                || !par1Block.shouldSideBeRendered(renderer.blockAccess, par2 + 1, par3, par4, 5)) {
                i1 = par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2 + 1, par3, par4);
            }

            f7 = renderer.blockAccess.getBlock(par2 + 1, par3, par4)
                .getAmbientOcclusionLightValue();
            f9 = (renderer.aoLightValueScratchXYPN + renderer.aoLightValueScratchXYZPNP
                + f7
                + renderer.aoLightValueScratchXZPP) / 4.0F;
            f8 = (renderer.aoLightValueScratchXYZPNN + renderer.aoLightValueScratchXYPN
                + renderer.aoLightValueScratchXZPN
                + f7) / 4.0F;
            ...
            f10 = (f7 + renderer.aoLightValueScratchXZPP
                + renderer.aoLightValueScratchXYPP
                + renderer.aoLightValueScratchXYZPPP) / 4.0F;
            f3 = (float) (f9 * (1.0D - renderer.renderMinY) * renderer.renderMaxZ
                + f8 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMaxZ)
                + f11 * renderer.renderMinY * (1.0D - renderer.renderMaxZ)
                + f10 * renderer.renderMinY * renderer.renderMaxZ);
            f4 = (float) (f9 * (1.0D - renderer.renderMinY) * renderer.renderMinZ
                + f8 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMinZ)
                + f11 * renderer.renderMinY * (1.0D - renderer.renderMinZ)
                + f10 * renderer.renderMinY * renderer.renderMinZ);
            f5 = (float) (f9 * (1.0D - renderer.renderMaxY) * renderer.renderMinZ
                + f8 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMinZ)
                + f11 * renderer.renderMaxY * (1.0D - renderer.renderMinZ)
                + f10 * renderer.renderMaxY * renderer.renderMinZ);
            f6 = (float) (f9 * (1.0D - renderer.renderMaxY) * renderer.renderMaxZ
                + f8 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMaxZ)
                + f11 * renderer.renderMaxY * (1.0D - renderer.renderMaxZ)
                + f10 * renderer.renderMaxY * renderer.renderMaxZ);
            k1 = renderer
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(RenderBlocks renderer, Block par1Block, int par2, int par3,
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 - 1, 2)) {
            ...
            f7 = renderer.blockAccess.getBlock(par2, par3, par4 - 1)
                .getAmbientOcclusionLightValue();
            f3 = (renderer.aoLightValueScratchXZNN + renderer.aoLightValueScratchXYZNPN
                + f7
                + renderer.aoLightValueScratchYZPN) / 4.0F;
            f4 = (f7 + renderer.aoLightValueScratchYZPN
                + renderer.aoLightValueScratchXZPN
            ...
            f5 = (renderer.aoLightValueScratchYZNN + f7
                + renderer.aoLightValueScratchXYZPNN
                + renderer.aoLightValueScratchXZPN) / 4.0F;
            f6 = (renderer.aoLightValueScratchXYZNNN + renderer.aoLightValueScratchXZNN
                + renderer.aoLightValueScratchYZNN
                + f7) / 4.0F;
            renderer.brightnessTopLeft = renderer
                .getAoBrightness(renderer.aoBrightnessXZNN, renderer.aoBrightnessXYZNPN, renderer.aoBrightnessYZPN, i1);
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 + 1, 3)) {
            ...
            f7 = renderer.blockAccess.getBlock(par2, par3, par4 + 1)
                .getAmbientOcclusionLightValue();
            f3 = (renderer.aoLightValueScratchXZNP + renderer.aoLightValueScratchXYZNPP
                + f7
                + renderer.aoLightValueScratchYZPP) / 4.0F;
            ...
            f5 = (renderer.aoLightValueScratchYZNP + f7
                + renderer.aoLightValueScratchXYZPNP
                + renderer.aoLightValueScratchXZPP) / 4.0F;
            f4 = (renderer.aoLightValueScratchXYZNNP + renderer.aoLightValueScratchXZNP
                + renderer.aoLightValueScratchYZNP
                + f7) / 4.0F;
            renderer.brightnessTopLeft = renderer
                .getAoBrightness(renderer.aoBrightnessXZNP, renderer.aoBrightnessXYZNPP, renderer.aoBrightnessYZPP, i1);
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 - 1, par3, par4, 4)) {
            ...
            f7 = renderer.blockAccess.getBlock(par2 - 1, par3, par4)
                .getAmbientOcclusionLightValue();
            f6 = (renderer.aoLightValueScratchXYNN + renderer.aoLightValueScratchXYZNNP
                + f7
                + renderer.aoLightValueScratchXZNP) / 4.0F;
            ...
            f4 = (renderer.aoLightValueScratchXZNN + f7
                + renderer.aoLightValueScratchXYZNPN
                + renderer.aoLightValueScratchXYNP) / 4.0F;
            f5 = (renderer.aoLightValueScratchXYZNNN + renderer.aoLightValueScratchXYNN
                + renderer.aoLightValueScratchXZNN
                + f7) / 4.0F;
            renderer.brightnessTopRight = renderer
                .getAoBrightness(renderer.aoBrightnessXYNN, renderer.aoBrightnessXYZNNP, renderer.aoBrightnessXZNP, i1);
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 + 1, par3, par4, 5)) {
            ...
            f7 = renderer.blockAccess.getBlock(par2 + 1, par3, par4)
                .getAmbientOcclusionLightValue();
            f3 = (renderer.aoLightValueScratchXYPN + renderer.aoLightValueScratchXYZPNP
                + f7
                + renderer.aoLightValueScratchXZPP) / 4.0F;
            f4 = (renderer.aoLightValueScratchXYZPNN + renderer.aoLightValueScratchXYPN
                + renderer.aoLightValueScratchXZPN
                + f7) / 4.0F;
    ...
    public boolean renderStandardBlockWithColorMultiplier(RenderBlocks renderer, Block par1Block, int par2, int par3,
        int par4, float par5, float par6, float par7) {
        renderer.enableAO = false;
        Tessellator tessellator = Tessellator.instance;
        boolean flag = false;
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 - 1, par4, 0)) {
            tessellator.setBrightness(
                renderer.renderMinY > 0.0D ? l
                    : par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2, par3 - 1, par4));
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 - 1, 2)) {
            tessellator.setBrightness(
                renderer.renderMinZ > 0.0D ? l
                    : par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2, par3, par4 - 1));
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 - 1, par3, par4, 4)) {
            tessellator.setBrightness(
                renderer.renderMinX > 0.0D ? l
                    : par1Block.getMixedBrightnessForBlock(renderer.blockAccess, par2 - 1, par3, par4));
    ...
    public void renderBottomFace(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6,
        IIcon par8Icon) {
        Tessellator tessellator = Tessellator.instance;
    ...
    public void renderTopFace(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6,
        IIcon par8Icon) {
        Tessellator tessellator = Tessellator.instance;
    ...
    public void renderEastFace(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6,
        IIcon par8Icon) {
        Tessellator tessellator = Tessellator.instance;
    ...
    public void renderWestFace(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6,
        IIcon par8Icon) {
        Tessellator tessellator = Tessellator.instance;
    ...
    public void renderNorthFace(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6,
        IIcon par8Icon) {
        Tessellator tessellator = Tessellator.instance;
    ...
    public void renderSouthFace(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6,
        IIcon par8Icon) {
        Tessellator tessellator = Tessellator.instance;
