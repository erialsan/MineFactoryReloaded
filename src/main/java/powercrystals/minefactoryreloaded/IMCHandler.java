...
public class IMCHandler {
    ...
    public static void processIMC(List<IMCMessage> l) {
        ...
        Logger _log = MineFactoryReloadedCore.instance()
            .getLogger();
        for (IMCMessage m : l) {
            try {
                String k = m.key;
                ...
                if ("addLaserPreferredOre".equals(k)) {
                    if (m.isNBTMessage()) {
                        ...
                        MFRRegistry
                            .addLaserPreferredOre(item.getInteger("value"), ItemStack.loadItemStackFromNBT(item));
                    } else {
                 ...
                 */
                    ...
                    if (m.isStringMessage()) MFRRegistry.registerAutoSpawnerBlacklist(m.getStringValue());
                    else MFRRegistry.registerAutoSpawnerBlacklistClass((Class<? extends EntityLivingBase>) getValue(m));
                }
                /*
                 * Fertilizables
                 */
                 ...
                 */
                    ...
                    if (m.isNBTMessage()) {
                        NBTTagCompound item = m.getNBTValue();
                        MFRRegistry.registerLaserOre(item.getInteger("value"), ItemStack.loadItemStackFromNBT(item));
                    } else {
                        ValuedItem item = (ValuedItem) getValue(m);
                 ...
                 */
                    ...
                    if (m.isStringMessage()) {
                        MFRRegistry.registerRedNetLogicCircuit(
                            (IRedNetLogicCircuit) Class.forName(m.getStringValue())
                                .newInstance());
                    } else {
                 ...
                 */
                    ...
                    MFRRegistry.registerSafariNetBlacklist((Class<? extends EntityLivingBase>) getValue(m));
                }
                /*
                 ...
                 */
                    ...
                    if (m.isNBTMessage()) {
                        NBTTagCompound item = m.getNBTValue();
                        MFRRegistry.registerSludgeDrop(item.getInteger("value"), ItemStack.loadItemStackFromNBT(item));
                    } else {
                        ValuedItem item = (ValuedItem) getValue(m);
                 ...
                 */
                    ...
                    MFRRegistry
                        .registerHarvestable(new HarvestableStandard(Block.getBlockFromName(m.getStringValue())));
                }
                /*
                 * HarvestableWood
                 */
                else if ("registerHarvestable_Log".equals(k)) {
                    MFRRegistry.registerHarvestable(new HarvestableWood(Block.getBlockFromName(m.getStringValue())));
                }
                /*
                 ...
                 */
                    ...
                    MFRRegistry
                        .registerHarvestable(new HarvestableTreeLeaves(Block.getBlockFromName(m.getStringValue())));
                }
                /*
                 * HarvestableVine
                 */
                else if ("registerHarvestable_Vine".equals(k)) {
                    MFRRegistry.registerHarvestable(new HarvestableVine(Block.getBlockFromName(m.getStringValue())));
                }
                /*
                 * HarvestableShrub
                 */
                else if ("registerHarvestable_Shrub".equals(k)) {
                    MFRRegistry.registerHarvestable(new HarvestableShrub(Block.getBlockFromName(m.getStringValue())));
                }
                /*
                 * HarvestableMushroom
                 */
                    ...
                    MFRRegistry
                        .registerHarvestable(new HarvestableMushroom(Block.getBlockFromName(m.getStringValue())));
                }
                /*
                 * HarvestableCrop
                 */
                    ...
                    if (m.isItemStackMessage()) {
                        ...
                        MFRRegistry.registerHarvestable(
                            new HarvestableCropPlant(Block.getBlockFromItem(item.getItem()), item.getItemDamage()));
                    } else {
                        ValuedItem item = (ValuedItem) getValue(m);
                 ...
                 */
                    ...
                    NBTTagCompound item = m.getNBTValue();
                    MFRRegistry.registerHarvestable(
                        new HarvestableStemPlant(
                            Block.getBlockFromName(item.getString("stem")),
                            Block.getBlockFromName(item.getString("fruit"))));
                    MFRRegistry
                        .registerHarvestable(new HarvestableGourd(Block.getBlockFromName(item.getString("fruit"))));
                }
                /**
                 * }
                 * {Plantables
                 ...
                 */
                    ...
                    NBTTagCompound item = m.getNBTValue();
                    if (item.hasKey("seed")) MFRRegistry.registerPlantable(
                        new PlantableSapling(
                            (Item) Item.itemRegistry.getObject(item.getString("seed")),
                            Block.getBlockFromName(item.getString("sapling"))));
                    else MFRRegistry
                        .registerPlantable(new PlantableSapling(Block.getBlockFromName(item.getString("sapling"))));
                }
                /*
                 * PlantableStandard
                 */
                 ...
                 */
                    ...
                    MFRRegistry.registerFertilizable(new FertilizableGrass(Block.getBlockFromName(m.getStringValue())));
                }
                /*
                 ...
                 */
                    ...
                    MFRRegistry.registerFertilizable(
                        new FertilizableStemPlants((IGrowable) Block.getBlockFromName(m.getStringValue())));
                }
                /*
                 ...
                 */
                    ...
                    NBTTagCompound item = m.getNBTValue();
                    if (item.hasKey("type")) MFRRegistry.registerFertilizable(
                        new FertilizableCropPlant(
                            (IGrowable) Block.getBlockFromName(item.getString("plant")),
                            FertilizerType.values()[item.getInteger("type")],
                            item.getInteger("meta")));
                    else MFRRegistry.registerFertilizable(
                        new FertilizableCropPlant(
                            (IGrowable) Block.getBlockFromName(item.getString("plant")),
                            item.getInteger("meta")));
                }
                 ...
                 */
                    ...
                    NBTTagCompound item = m.getNBTValue();
                    if (item.hasKey("type")) MFRRegistry.registerFertilizable(
                        new FertilizableCocoa(
                            Block.getBlockFromName(item.getString("plant")),
                            FertilizerType.values()[item.getInteger("type")]));
                    else MFRRegistry
                        .registerFertilizable(new FertilizableCocoa(Block.getBlockFromName(item.getString("plant"))));
                }
                /*
                 ...
                 */
                    ...
                    NBTTagCompound item = m.getNBTValue();
                    if (item.hasKey("type")) MFRRegistry.registerFertilizable(
                        new FertilizableStandard(
                            (IGrowable) Block.getBlockFromName(item.getString("plant")),
                            FertilizerType.values()[item.getInteger("type")]));
                    else MFRRegistry.registerFertilizable(
                        new FertilizableStandard((IGrowable) Block.getBlockFromName(item.getString("plant"))));
                }
                /**
                 * }
                 */
