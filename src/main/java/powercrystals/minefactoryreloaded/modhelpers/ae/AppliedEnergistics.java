...
public class AppliedEnergistics {
    ...
    public static void load(FMLInitializationEvent e) {
        ...
        FMLInterModComms
            .sendMessage("appliedenergistics2", "add-p2p-attunement-fluid", Machine.LiquidRouter.getItemStack());
        FMLInterModComms
            .sendMessage("appliedenergistics2", "add-p2p-attunement-item", Machine.ItemRouter.getItemStack());
        for (int i = 17; i-- > 0;) FMLInterModComms.sendMessage(
            "appliedenergistics2",
