...
public class Vanilla {
    ...
    public void load(FMLInitializationEvent event) {
        ...
        MFRRegistry.registerGrindable(
            new GrindableStandard(
                EntityChicken.class,
                new MobDrop[] { new MobDrop(30, null), new MobDrop(10, new ItemStack(Items.egg)) },
                false));
        MFRRegistry.registerGrindable(
            new GrindableStandard(
                EntityOcelot.class,
                new MobDrop[] { new MobDrop(10, new ItemStack(Items.fish)),
    ...
    private void registerOreDictLaserOre(int weight, String name, int focus, String netherName, int netherFocus) {
        ...
        for (ItemStack ore : OreDictionary.getOres(name)) if (ore != null) {
            ore = ore.copy();
            ore.stackSize = 1;
        ...
        if (netherName != null) for (ItemStack ore : OreDictionary.getOres(netherName)) if (ore != null) {
            registerOreDictLaserOre(weight / 2, netherName, netherFocus, null);
            return;
        }
    }
