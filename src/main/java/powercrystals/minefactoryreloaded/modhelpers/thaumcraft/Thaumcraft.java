...
public class Thaumcraft {
    ...
    public void load(FMLInitializationEvent e) {
        ...
        try {
            ...
            Class<? extends EntityLivingBase> golem = (Class<? extends EntityLivingBase>) Class
                ...
                trunk = (Class<? extends EntityLivingBase>) Class
                    .forName("thaumcraft.common.entities.golems.EntityTravelingTrunk"),
                pech = (Class<? extends EntityLivingBase>) Class
            ...
            MFRRegistry
                .registerHarvestable(new HarvestableThaumcraftLeaves(tcLeaves, Item.getItemFromBlock(tcSapling)));
    ...
    public void loadManabean(FMLInitializationEvent e) {
        ...
        try {
            ...
            MFRRegistry.registerHarvestable(new HarvestableStandard(tcPod) {
                ...
                @Override
                public boolean canBeHarvested(World world, java.util.Map<String, Boolean> settings, int x, int y,
                    int z) {

                    if (settings.get("isHarvestingTree") == Boolean.TRUE) return true;
            ...
            MFRRegistry.registerPlantable(new PlantableStandard(tcBean, tcPod) {
                ...
                protected boolean isNextToAcceptableLog(World world, int x, int y, int z) {
                    ...
                    if (biome != null) isMagic = BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.MAGICAL);
        ...
        try {
            ...
            MFRRegistry.registerPlantable(new PlantableCocoa(tcBean, tcPod) {
                ...
                protected boolean isNextToAcceptableLog(World world, int x, int y, int z) {
                    ...
                    BiomeGenBase biome = world.getBiomeGenForCoords(x, z);
                    if (biome != null) isMagic = BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.MAGICAL);
                    return isMagic && isGoodLog(world, x + 1, y, z) || isGoodLog(world, x - 1, y, z)
    ...
    private static void doAspects() throws Throwable {
        ...
        for (int i = 0, n = 10; i <= n; ++i) parseAspects(upgradeItem, i, "2 cognitio", true);
