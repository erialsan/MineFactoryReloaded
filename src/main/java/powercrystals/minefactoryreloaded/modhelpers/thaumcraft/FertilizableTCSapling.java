...
public class FertilizableTCSapling extends FertilizableBase {
    ...
    public FertilizableTCSapling(Block tcplant) {
        ...
        try {
            ...
            growSilverWood = plant
                .getDeclaredMethod("growSilverTree", World.class, int.class, int.class, int.class, Random.class);
            growGreatWood = plant
                .getDeclaredMethod("growGreatTree", World.class, int.class, int.class, int.class, Random.class);
