...
public class TwilightForest {
    ...
    public void load(FMLInitializationEvent e) {
        ...
        try {
            ...
            entityEggs = (HashMap) Class.forName("twilightforest.entity.TFCreatures")
                .getField("entityEggs")
                .get(null);
            twilightForestContainer = FMLCommonHandler.instance()
                .findContainerFor(
            ...
            MFRRegistry.registerHarvestable(
                new HarvestableWood(
                    ((Block) tfBlocks.getField("log")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableWood(
                    ((Block) tfBlocks.getField("giantLog")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableWood(
                    ((Block) tfBlocks.getField("magicLog")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableWood(
                    ((Block) tfBlocks.getField("magicLogSpecial")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableWood(
                    ((Block) tfBlocks.getField("hugeStalk")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableStandard(
                    ((Block) tfBlocks.getField("root")
                        .get(null)),
                    HarvestType.TreeFlipped));
            MFRRegistry.registerHarvestable(
                new HarvestableStandard(
                    ((Block) tfBlocks.getField("hugeGloomBlock")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("leaves")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("leaves3")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("darkleaves")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("giantLeaves")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("magicLeaves")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("thornRose")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("hedge")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("firefly")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableTreeLeaves(
                    ((Block) tfBlocks.getField("cicada")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableShearable(
                    ((Block) tfBlocks.getField("plant")
                        .get(null))));
            MFRRegistry.registerHarvestable(
                new HarvestableShearable(
                    ((Block) tfBlocks.getField("trollBer")
                        .get(null)),
                    HarvestType.Column));

            MFRRegistry.registerPlantable(
                new PlantableSapling(
                    ((Block) tfBlocks.getField("sapling")
                        .get(null))));
            MFRRegistry.registerPlantable(
                new PlantableStandard(
                    ((Item) tfItems.getField("torchberries")
                        .get(null)),
                    ((Block) tfBlocks.getField("unripeTrollBer")
                        .get(null))));

            MFRRegistry.registerFertilizable(
                new FertilizableStandard(
                    ((IGrowable) tfBlocks.getField("sapling")
                        .get(null))));
