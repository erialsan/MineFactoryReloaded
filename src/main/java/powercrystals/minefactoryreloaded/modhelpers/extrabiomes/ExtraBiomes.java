...
@ChildMod(
    ...
    mod = @Mod(
        modid = "MineFactoryReloaded|CompatExtraBiomes",
        name = "MFR Compat: ExtraBiomes",
        version = MineFactoryReloadedCore.version,
        dependencies = "after:MineFactoryReloaded;after:ExtrabiomesXL",
...
public class ExtraBiomes {
    ...
    public void load(FMLInitializationEvent ev) {
        ...
        try {
             ...
             * MFRRegistry.registerSludgeDrop(15, new
             * ItemStack((Integer)xbbs.getMethod("getID").invoke(xbbs.getField("QUICKSAND").get(null)), 1, 0));
             * MFRRegistry.registerSludgeDrop(15, new
             * ItemStack((Integer)xbbs.getMethod("getID").invoke(xbbs.getField("CRACKEDSAND").get(null)), 1, 0));
             * //
             */
