...
public class Atum {
    ...
    public void load(FMLInitializationEvent e) {
        ...
        try {
            ...
            Block atumLogId = ((Block) AtumBlocks.getField("log")
                .get(null));
            Block atumLeavesId = ((Block) AtumBlocks.getField("leaves")
                .get(null));
            Block atumSaplingId = ((Block) AtumBlocks.getField("palmSapling")
                .get(null));

            Item flaxSeedsId = ((Item) AtumItems.getField("flaxSeeds")
                .get(null));

            Block flaxId = ((Block) AtumBlocks.getField("flax")
                .get(null));
            Block papyrusId = ((Block) AtumBlocks.getField("papyrus")
                .get(null));
            Block shrubId = ((Block) AtumBlocks.getField("shrub")
                .get(null));
            Block weedId = ((Block) AtumBlocks.getField("weed")
                .get(null));

            Method atumSaplingGrowTree = Class.forName("rebelkeithy.mods.atum.blocks.BlockPalmSapling")
                .getMethod("growTree", World.class, int.class, int.class, int.class, Random.class);
            Method atumFlaxFertilize = Class.forName("rebelkeithy.mods.atum.blocks.BlockFlax")
                .getMethod("fertilize", World.class, int.class, int.class, int.class);
