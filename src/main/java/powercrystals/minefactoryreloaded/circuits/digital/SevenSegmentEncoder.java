...
public class SevenSegmentEncoder extends StatelessCircuit {
    ...
    public int[] recalculateOutputValues(long worldTime, int[] inputValues) {
        ...
        return new int[] { _outputMatrix[inputValues[0]][0], _outputMatrix[inputValues[0]][1],
            _outputMatrix[inputValues[0]][2], _outputMatrix[inputValues[0]][3], _outputMatrix[inputValues[0]][4],
            _outputMatrix[inputValues[0]][5], _outputMatrix[inputValues[0]][6], };
    }
