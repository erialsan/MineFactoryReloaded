...
public class ButtonLogicBufferSelect extends ElementButtonOption {
    ...
    public ButtonLogicBufferSelect(GuiRedNetLogic containerScreen, int x, int y, int pinIndex,
        LogicButtonType buttonType, int rotation) {
        ...
        for (int i = 0; i < 4; ++i) dirMap[(i + rotation) & 3] = dir[i];
