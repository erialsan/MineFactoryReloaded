...
public class ButtonLogicPinSelect extends ElementButtonManaged {
    ...
    private static GuiColor[] _pinColors = new GuiColor[] { new GuiColor(223, 223, 223), // white
    ...
    private static String[] _pinColorNames = new String[] { "WHIT", "ORNG", "MGTA", "L_BL", "YLLW", "LIME", "PINK",
        "GRAY", "SILV", "CYAN", "PURP", "BLUE", "BRWN", "GRN", "RED", "BLK", };
    ...
    public ButtonLogicPinSelect(GuiRedNetLogic containerScreen, int x, int y, int pinIndex,
        LogicButtonType buttonType) {
    ...
    private static final int getMult() {
        ...
        if (MFRUtil.isAltKeyDown()) if (MFRUtil.isShiftKeyDown()) if (MFRUtil.isCtrlKeyDown()) return 64;
        else return 32;
        else if (MFRUtil.isCtrlKeyDown()) return 6; // break from multiplying so there's not two 8s
        else return 4;
        else if (MFRUtil.isShiftKeyDown()) if (MFRUtil.isCtrlKeyDown()) return 16;
        else return 8;
        else if (MFRUtil.isCtrlKeyDown()) return 2;
        else return 1;
    }
