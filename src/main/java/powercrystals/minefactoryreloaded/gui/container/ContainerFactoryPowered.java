    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < crafters.size(); i++) {
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 0, ((TileEntityFactoryPowered) _te).getWorkDone() & 65535);
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 1, ((TileEntityFactoryPowered) _te).getEnergyStored() & 65535);
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 2, ((TileEntityFactoryPowered) _te).getIdleTicks());
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 3, (((TileEntityFactoryPowered) _te).getEnergyStored() >> 16) & 65535);
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 4, ((TileEntityFactoryPowered) _te).getWorkDone() >> 16);
        }
    }
