    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < crafters.size(); i++) {
            ...
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 101, ((TileEntityLaserDrill) _te).getWorkDone() >> 16);
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 102, ((TileEntityLaserDrill) _te).getEnergyStored());
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 103, ((TileEntityLaserDrill) _te).getEnergyStored() >> 16);
        }
    }
