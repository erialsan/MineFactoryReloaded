    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < crafters.size(); i++) {
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 100, ((TileEntityAutoSpawner) _te).getSpawnExact() ? 1 : 0);
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 101, ((TileEntityFactoryPowered) _te).getWorkMax() & 65535);
            ((ICrafting) crafters.get(i))
                .sendProgressBarUpdate(this, 102, ((TileEntityFactoryPowered) _te).getWorkMax() >>> 16);
        }
    }
