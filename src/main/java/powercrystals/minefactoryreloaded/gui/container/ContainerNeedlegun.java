...
public class ContainerNeedlegun extends Container {
    ...
    protected void bindPlayerInventory(InventoryPlayer inventoryPlayer) {
        ...
        for (int i = 0; i < 9; i++) {
            if (i == _nsi) addSlotToContainer(new SlotViewOnly(inventoryPlayer, i, 8 + i * 18, 84 + 58));
            else addSlotToContainer(new Slot(inventoryPlayer, i, 8 + i * 18, 84 + 58));
        }
    }
    ...
    public void onContainerClosed(EntityPlayer player) {
        ...
        else player.func_146097_a(((Slot) inventorySlots.get(0)).getStack(), false, true);
