...
public class GrindableZombiePigman implements IFactoryGrindable {
    ...
    static {
        ...
        list.appendTag(
            MFRUtil.writeModifierToNBT(SharedMonsterAttributes.maxHealth.getAttributeUnlocalizedName(), modifier));
    ...
    public List<MobDrop> grind(World world, EntityLivingBase entity, Random random) {
        ...
        if (random.nextInt(3000) == 0) drops.add(new MobDrop(10, sign.copy()));
